...
/**
* @author xiaoxi
* @description 针对表【interface_info_order(接口商品订单)】的数据库操作Service实现
...
public class InterfaceInfoOrderServiceImpl extends ServiceImpl<InterfaceInfoOrderMapper, InterfaceInfoOrder>
    ...
    // MQ消息过期时间,10分钟
    public static final String MESSAGE_EXPRIE_TIME = String.valueOf(10 * 60 * 1000);
